...
|---|---|
| Tool catalog | Non-additive profiles: 383 core tools / 2845 read-only optional starters / 5825 read-write optional starters; REST/OpenAPI platform API backend total: 6,713; protocol-only Central Streaming: 1; cross-platform site-health: 1; complete backend index: 6,732; direct-all: 6,751 |
