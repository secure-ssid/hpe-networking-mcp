...
the index. `--min-tools 6705` is the platform API compatibility floor (the
6,705 vendor-facing platform API tools), not the complete registered backend
total of 6,717 — validation passes at or above the floor; see
