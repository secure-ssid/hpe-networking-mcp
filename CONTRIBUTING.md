...
the index. `--min-tools 6704` is the platform API compatibility floor (the
6,704 vendor-facing platform API tools), not the complete registered backend
total of 6,716 — validation passes at or above the floor; see
