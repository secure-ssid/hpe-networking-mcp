...
the index. `--min-tools 6706` is the platform API compatibility floor (the
6,706 vendor-facing platform API tools), not the complete registered backend
total of 6,719 — validation passes at or above the floor; see
