...
def default_routes() -> list[Route]:
    ...
    return [
        ...
        Route(
            "GET", "/network-monitoring/v1/clients/{mac}", READ, collection="clients", by_id=True
        ),
        ...
        Route(
            ...
            READ,
            collection="onboarding_reasons",
        ),
        Route(
            "GET",
            "/network-monitoring/v1/clients/{mac}/mobility-trail",
            READ,
            collection="mobility_trails",
            by_id=True,
        ),
        Route(
            "GET",
        ...
        Route(
            ...
            READ,
            collection="sites_client_health",
            paginated=True,
        ),
        Route(
            "GET",
        ...
        Route(
            "GET",
            "/network-monitoring/v1/aps/{serial}/cpu-utilization-trends",
            READ,
            collection="ap_cpu_trends",
        ),
        Route(
            "GET",
            "/network-monitoring/v1/aps/{serial}/memory-utilization-trends",
            READ,
            collection="ap_mem_trends",
        ),
        # --- network-config (reads then writes) ---
        Route("GET", "/network-config/v1/wlan-ssids/{ssid}", READ, collection="wlans", by_id=True),
        Route(
            "PATCH",
            "/network-config/v1/wlan-ssids/{ssid}",
            CONFIG_WRITE,
            collection="wlans",
            by_id=True,
        ),
        ...
        Route(
            "GET", "/network-config/v1alpha1/cnac-mac-reg", READ, collection="nac", paginated=True
        ),
        ...
        Route(
            ...
            READ,
            collection="firmware_compliance",
        ),
        Route(
            "GET", "/network-config/v1alpha1/firmware-details", READ, collection="firmware_details"
        ),
        Route("GET", "/network-services/v1/firmware-details", READ, collection="firmware_details"),
        Route(
            "GET",
            "/network-services/v1/firmware-details/{serial}",
            READ,
            collection="firmware_details",
            by_id=True,
        ),
        Route(
            "POST",
            "/network-config/v1alpha1/device-firmware",
            CONFIG_WRITE,
            collection="device_firmware",
        ),
        Route(
            "PATCH",
            "/network-config/v1alpha1/device-firmware",
        ...
        Route(
            ...
            READ,
            collection="config_health_issues",
        ),
        Route(
            "POST",
        ...
        Route(
            "POST",
            "/network-troubleshooting/v1/cx/{serial}/showCommands",
            DIAGNOSTIC,
            collection="show_command_jobs",
        ),
        Route(
            "GET",
            "/network-troubleshooting/v1/cx/{serial}/show-commands",
            READ,
            collection="show_command_jobs",
        ),
        Route(
        ...
        Route(
            "POST",
            "/network-troubleshooting/v1/aps/{serial}/aaa",
            DIAGNOSTIC,
            collection="aaa_results",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/aps/{serial}/disconnectUserByMacAddress",
            WRITE,
            collection="disconnect_jobs",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/aps/{serial}/disconnectUserAll",
            DESTRUCTIVE,
            collection="disconnect_jobs",
        ),
        # --- destructive actions ---
        Route(
            "POST",
            "/network-troubleshooting/v1/cx/{serial}/portBounce",
            DESTRUCTIVE,
            collection="bounce_jobs",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/cx/{serial}/poeBounce",
            DESTRUCTIVE,
            collection="bounce_jobs",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/cx/{serial}/reboot",
            DESTRUCTIVE,
            collection="reboot_jobs",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/aps/{serial}/reboot",
            DESTRUCTIVE,
            collection="reboot_jobs",
        ),
        Route(
            "POST",
            "/network-troubleshooting/v1/aps/{serial}/rebootSwarm",
            DESTRUCTIVE,
            collection="reboot_jobs",
        ),
    ]
