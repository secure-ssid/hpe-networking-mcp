...
| RAG / API lookup | 0 | 0 | 13 | **13** | 13 | 0 | 0 | 0 | committed application code; Local indexes over cited sources; No platform auth |
...
| **Total** | **6,144** | **6,127** | **578** | **6,705** | **3,154** | **165** | **2,544** | **842** | |

The 6,144 manifest records are provenance-bearing generated operations. Only 6,127 register as executable generated tools because 17 are intentionally excluded. Adding 578 curated tools yields 6,705 executable platform API backend tools. The three minimal-router tools are a separate client-visible dispatch surface, not three additional backend capabilities.
...
- **6,705 platform API tools vs. 4,109** compares executable backend registries, but generation strategy and curated overlap differ; it does not prove practical superiority.
