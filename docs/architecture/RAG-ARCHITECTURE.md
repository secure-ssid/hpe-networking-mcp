...
345 lifecycle records. The rebuilt router index contains 6,731 backend
...
profiles contain 382 core tools / 2844 read-only optional starters / 5824 read-write optional starters; those optional profiles now map to
