...
**Current evaluated corpus:** 97,783 prose chunks across the released
...
346 lifecycle records. The rebuilt router index contains 6,716 backend
tools. Minimal mode keeps this
catalog behind the three-tool discovery/dispatch surface; direct-all mode
exposes 6,723 tools including the router itself. The current 33-question eval
...
profiles contain 369 core tools / 2830 read-only optional starters / 5810 read-write optional starters; those optional profiles now map to
...
current manifest covers 17 rebuild sources, including DevHub, Switching Feature
Navigator, Juniper EX-series/AP product datasheets, the complete HPE Aruba
Networking CSAF advisory archive, HPE Networking end-of-sale notices, and
official Mist/Apstra lifecycle and security-advisory pages. Keep those inputs
