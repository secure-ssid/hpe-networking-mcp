...
345 lifecycle records. The rebuilt router index contains 6,727 backend
...
three-tool discovery/dispatch surface; direct-all mode exposes 6,734 tools
...
profiles contain 379 core tools / 2841 read-only optional starters / 5821 read-write optional starters; those optional profiles now map to
