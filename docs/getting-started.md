...
token cost low. The router can search 6,728 backend tools when all platforms
...
The safe default hides optional write tools. Build all 6,728 backend tools only
