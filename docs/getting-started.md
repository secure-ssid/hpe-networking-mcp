...
token cost low. The router can search 6,719 backend tools when all platforms
...
The safe default hides optional write tools. Build all 6,719 backend tools only
