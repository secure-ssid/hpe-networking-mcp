...
token cost low. The router can search 6,732 backend tools when all platforms
...
The safe default hides optional write tools. Build all 6,732 backend tools only
...
total of 6,732, which also includes the non-platform backends itemized in
