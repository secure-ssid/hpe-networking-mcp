...
registry itself) for **6,737 client-visible tools total**. The recommended
...
| `direct` + `HPE_MCP_TOOLSETS=all` | 6,737 | Full schema introspection and debugging |
...
`direct` mode's 6,737 = the complete 6,729 backend total + 8 router-native
